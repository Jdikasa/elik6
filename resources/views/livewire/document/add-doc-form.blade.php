<form action="{{ route('pm.documents.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="body-siderbar">
        <div class="form-group row g-3">
            ...
            <div class="col-12">
                <div class="block-file block-import-doc">
                    <input type="file" id="file-upload" name="document" accept="image/*,.pdf, .docx" multiple required>
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-7">
                        <input type="text" class="form-control" name="ref" placeholder="Référence" required>
                    </div>
                </div>
            </div>
