                    ...
                    <div class="px-3 py-4 card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" placeholder="A quelle adresse cette cotation est-elle destinée ?" id="invoiceAddressToLabel"
                            ...
                            <div class="col-12">
                                ...
                                <!-- Flatpickr -->
                                <select name="country_id" id="" class="form-control form-select"
                                    wire:model='stat.certificat_id' wire:change='selectCertificat'
                                    @disabled($hasItem)>
                                    <option value="" selected disabled>Selectionnez un client</option>
                                    @foreach ($stat['countries'] as $country)
                                        <option value="{{ $country->id }}">
                                            {{ $country->country->name_fr ?? $country->country->name_en }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-12">
                                <label for="" class="form-label">Partenaire : </label>
                                <select name="partenaire_id" id="" class="form-control form-select"
                                    wire:model='stat.partenaire_id'>
                                    <option value="" selected disabled>Selectionnez un partenaire</option>
                                    @foreach ($stat['partenaires'] as $partenaire)
                            ...
                            <div class="col-12">
                                <label for="" class="form-label">Equipement : </label>
                                <select name="" id="" class="form-control form-select"
                                    wire:model='stat.selected_product'>
                                    <option value="" selected disabled>Selectionnez un equipement</option>
                                    @foreach ($stat['products'] as $product)
                        ...
                        <form action="{{ route('pm.fin.cotations.store') }}" id="bill-form" method="POST">
                            @csrf
                            @php
                                $total = 0;
                                $tax = 0;
                            ...
                            <input type="hidden" name="country_id" value="{{ $stat['certificat_id'] }}">
                            ...
                            <dl class="mb-0 d-flex justify-content-between align-items-center">
                                ...
                                <dd class="p-0 mb-0 border ms-1 col-md-auto border-bottom-0">
                                    <span class="p-1 text-center d-block"
                                        style="width: 110px">{{ $stat['num_cotation'] }}</span>
                                </dd>
                            </dl>
                ...
                <div class="mb-3 row justify-content-md-end">
                            ...
                            <tbody>
                                <td class="">
                                    <small style="font-size: 11px">
                                        ...
                                        2. Veillez inclure le numérro de la cotation dans le mail<br>
                    ...
                    <div class="mb-5 col-md-5 ps-0">
                        <dl class="row text-md-end" style="font-size: 12px">
                            ...
                            <dt class="col-md-6">Montant TTC:</dt>
