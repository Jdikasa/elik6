    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('pm.personnels.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row g-3">
                        <div class="col-12">
                            <h6>Informations personneles</h6>
                        </div>
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="post_nom" placeholder="Post-nom">
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <input type="date" name="date_naiss" class="form-control" placeholder="Date de naissance">
                        </div>
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="provice" class="form-control" placeholder="Provice d'origine">
                        </div>
                        ...
                        <div class="col-lg-6">
                            <input type="number" name="nbr_enfants" class="form-control" placeholder="Nombre d'enfants">
                        </div>

                        <div class="col-lg-12">
                            <textarea name="adresse" class="form-control" placeholder="Adresse complete" id="" cols="30" rows="3"></textarea>
                        </div>

                        <div class="col-12">
                            <h6>Informations professionnele</h6>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="date_contrat" class="form-control" placeholder="Date debut du contrat" onfocus="(this.type='date')" onblur="(this.type='text')">
                        </div>
                        <div class="col-lg-6">
                            <input type="text" name="date_fin_contrat" class="form-control" placeholder="Date de fin du contrat" onfocus="(this.type='date')" onblur="(this.type='text')">
                        </div>

                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-8 pe-0">
                                    <input type="text" name="salaire" class="form-control flex-grow" placeholder="Salaire de base convenu">
                                </div>
                                <div class="col-4">
...
<div class="modal fade" id="modal-new-departement" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('pm.departements.store') }}" method="POST">
                    @csrf
                    <div class="form-group row g-4">
                        <div class="col-lg-12">
