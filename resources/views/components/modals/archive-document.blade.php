{{-- ajouter --}}
<div class="modal fade" id="modal-new-archive-document"   tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="form-group row g-4">
                <form action="{{ route('pm.documents.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12 text-end">
                        <button class="btn btn-add" type="submit" data-bs-dismiss="modal" aria-label="Close">Ajouter</button>
                    </div>
                </form>
            </div>
        </div>
