<x-form-section submit="updateProfileInformation" class="card">
    <x-slot name="title">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-2" x-show="! photoPreview">
                    <img src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->name }}" class="object-cover w-20 h-20 p-1 bg-white border rounded-full">
                </div>
                ...
                @if ($this->user->profile_photo_path)
                    <x-secondary-button type="button" class="mt-2 btn-danger" wire:click="deleteProfilePhoto">
                        {{ __('Remove Photo') }}
                    </x-secondary-button>
                @endif
