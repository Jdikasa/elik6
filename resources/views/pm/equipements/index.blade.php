        ...
        <div class="page-header card card-lg">
            <div class="text-star">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center">
                    ...
                    <div class="ms-auto">
                        <a href="{{ route('pm.products.create') }}" class="btn btn-light rounded-pill">
                                ...
                                <div class="card-body">
                                    <div class="gap-3 d-grid">
                                        ...
                                        <label class="row form-check form-switch" for="toggleColumn_country">
                                            <span class="col-8 col-sm-9 ms-0">
                                                <span class="me-2">Bande de fréquence</span>
                                            </span>
                                            <span class="col-4 col-sm-3 text-end">
                        ...
                        @foreach ($products as $product)
                            ...
                            <tr>
                                <td class="table-column-pe-0">
                                    <div class="form-check">
                                        <input type="checkbox" name="ids[]" class="form-check-input users-data-check" value="{{ $product->id }}" id="usersDataCheck{{ $product->id }}">
                                        <label class="form-check-label" for="usersDataCheck{{ $product->id }}"></label>
                                    </div>
                                </td>
                                <td class="table-column-ps-0" style="max-width: 180px">
                                    <a class="d-flex align-items-center" href="{{ route('pm.clients.show', $product) }}">
                                        <div class="flex-shrink-0">
                                            @if ($product->image)
                                                <div class="avatar avatar-circle">
                                                    <img class="avatar-img" src="{{ asset('storage') . '/' . $product->image }}"
        ...
        <div class="modal-dialog">
            <form class="modal-content" action="#" method="POST" id="bulk-delete-form">
                ...
                <div class="modal-body text-center">
                    <h5>
                        <i class="bi bi-warning"></i>
                        Etez-vous sûr de vouloire supprimer ces équipement ?
                    </h5>
                </div>
                <div class="modal-footer">
                    <a href="#" class="btn btn-success" data-bs-dismiss="modal">Annuler</a>
...
@section('javascript')
    ...
    <script>
        $(document).ready(function() {
            ...
            // var deleteToggle2 = $('#delete-toggle2');
            ...
            bulkdeleteToggle.on('click', function() {
                ...
                // console.log(ids);
                bulkDeleteForm.attr('action', '{{ route('pm.products.bulkDestroy', '__ids') }}'.replace('__ids', ids));
            });
