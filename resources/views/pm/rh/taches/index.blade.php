            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="text-star">
                        ...
                        <p>Vous avez 10 nouvelles taches à effectuer, 10 taches encours et 10 taches hors delais</p>
                    </div>
                    <div class="mt-4 row">
                        <div class="col-lg-12">
                            <div class="block-info-formule d-flex">
                                ...
                                <div class="text">
                                    ...
                                    <h6>{{ Str::ucfirst(Auth::user()->agent?->fonction()->titre) }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5">
                    <img src="{{ asset('assets/images/svg.svg') }}" alt="" class="svg">
                </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            @if ($tache->progression == '0' && $tache->statut_id == '1')
                                <div class="dropdown">
                                    <button class="px-0 btn btn-end ms-2" id="dropdownMenuButton1"
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="">
                                        ...
                                        <li>
                                            <a class="dropdown-item delete" href="#" data-id="{{ $tache->id }}">Supprimer</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                        ...
                        <div class="col-lg-5">
                            <div class="items">
                                ...
                                <div class="d-flex w-100 align-items-center">
                                    ...
                                    <h6 class="mb-0 ms-2">{{ $tache->user->agent->prenom . ' ' . $tache->user->agent->nom }}</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                                ...
                                <div class="block-all-membres">
                                    @foreach ($tache->pivotusertaches as $pivotusertache)
                                        <div class="avatar-membre" data-bs-toggle="modal"
                                            ...
                                            <img src="{{ imageOrDefault($pivotusertache->employe->image) }}" alt="image profil">
                                        </div>
                                    @endforeach
                                    @if ($tache->progression == '0' && $tache->statut_id == '1' &&
                                        $tache->pivotusertaches->where('tache_id', $tache->id)->count() != $users->count())
                                        <div class="avatar-membre" data-bs-toggle="modal"
                        ...
                        <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="form-check ms-4">
                                            ...
                                            <label class="form-check-label ms-2 col-12" for="flexCheckDefault">
                                                @if ($cible->statut == '1')
                                                    ...
                                                    <span class="text-end">{{ $cible->user->agent->prenom . ' ' . $cible->user->agent->nom }}</span>
                                                @else
                                                    {{ $cible->libelle }}
                                                @endif
                                            </label>
                            ...
                            <div class="tab-pane fade" id="comment-{{ $tache->id }}" role="tabpanel"
                                ...
                                <div class="all-comments pe-3"
                                    ...
                                    @if ($tache->pivotusertaches->where('agent_id', Auth::user()->id)->first() != null &&
                                        $tache->progression == '0')
                            ...
                            <div class="tab-pane fade" id="fichier-{{ $tache->id }}" role="tabpanel"
                                ...
                                @if ($tache->pivotusertaches->where('agent_id', Auth::user()->agent->id)->first() != null &&
                                    $tache->progression == '0')
                                    <div class="p-0 bg-white offcanvas-footer w-100"
                                        style="position: absolute; bottom: 0vw;">
                                        <div class="block-comment d-flex align-items-center"
                                ...
                                @foreach ($tache->pivotusertaches as $pivotusertache)
                                    <div class="col-lg-8">
                                        <select class="form-select" aria-label="Default select example">
                                            <option value="" selected disabled>Selectionnez</option>
                                            <option>
                                                {{ $pivotusertache->employe->prenom . ' ' . $pivotusertache->employe->nom }}
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-4">
