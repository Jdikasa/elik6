                    ...
                    <div class="block-user-info">
                        ...
                        <div class="row justify-content-center g-3">
                            <div class="col-12 text-star">
                                <h5>Direction</h5>
                                <p class="mb-0">{{ $agent->fonction()?->direction?->titre }}</p>
                            </div>
                            <div class="col-12 text-star">
                                <h5>Poste</h5>
                                <p class="mb-0">{{ $agent->fonction()?->titre }}</p>
                            ...
                            <div class="info-lg">
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-4 col-6 col-sm-4 col-md-4">
                                        <div class="items">
                                            <p>Classification</p>
                                            <h6>{{ $agent->fonction()->classification->libelle ?? "" }}</h6>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-6 col-sm-4 col-md-4">
                                        <div class="items">
                                            <p>Catégorie</p>
                                            <h6>{{ $agent->fonction()->categorie->libelle ?? "" }}</h6>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-6 col-sm-4 col-md-4">
                                        <div class="items">
                                            <p>Poste</p>
                                            <h6>{{ $agent->fonction()?->titre }}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <select class="form-select" name="direction_id"
                                                ...
                                                @foreach ($directions as $direction)
                                                    <option value="{{ $direction->id }}" @selected($agent->fonction()?->direction && $agent->fonction()?->direction->is($direction) ? true : $agent->fonction()?->service?->direction->id == $direction->id)>
                                                        {{ $direction->titre }}
                                                    </option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="info-lg">
                                ...
                                <form method="post" action="{{ route('rh.user.permissions') }}">
                                    ...
                                    <div class="form-group row g-3 justify-content-center">
                                        ...
                                        <div class="mt-4 col-lg-12 text-end">
                                            <button class="btn btn-add float-end">Enregister</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
