                                    ...
                                    <div class="gap-3 d-grid">
                                        ...
                                        <label class="row form-check form-switch" for="toggleColumn_name">
                                            <span class="col-8 col-sm-9 ms-0">
                                                <span class="me-2">Non Client</span>
                                            </span>
                                        ...
                                        <label class="row form-check form-switch" for="toggleColumn_phone">
                                            <span class="col-8 col-sm-9 ms-0">
                                                <span class="me-2">Date soumission</span>
                                            </span>
                                            <span class="col-4 col-sm-3 text-end">
                                        ...
                                        <label class="row form-check form-switch" for="toggleColumn_country">
                                            <span class="col-8 col-sm-9 ms-0">
                                                <span class="me-2">Date cloture</span>
                                            </span>
                                            <span class="col-4 col-sm-3 text-end">
                                        ...
                                        <label class="row form-check form-switch" for="toggleColumn_account_prix">
                                            <span class="col-8 col-sm-9 ms-0">
                                                <span class="me-2">Prochaine màj</span>
                                            </span>
                                            <span class="col-4 col-sm-3 text-end">
                                                <input type="checkbox" class="form-check-input"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="gap-3 d-flex align-items-center fs-6">
                                        <a href="{{ route('pm.projects.show', $projet) }}" class="text-primary"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
                                            data-bs-original-title="View detail" aria-label="Views">
                                            <i class="bi bi-eye-fill"></i>
                                        </a>

                                        <a href="{{ route('pm.projects.edit', $projet) }}" class="text-warning"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
                                            data-bs-original-title="Edit info" aria-label="Edit"><i
                                                class="bi bi-pencil-fill"></i></a>
                                        <a href="javascript:;" class="text-danger delete-toggle" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal" data-id="{{ $projet->id }}"
            ...
            <form class="modal-content" action="#" method="POST" id="delete-form">
                ...
                <div class="modal-body text-center">
                    <h5>
                        ...
                        Etez-vous sûr de vouloire supprimer ce projet ?
                    </h5>
                </div>
