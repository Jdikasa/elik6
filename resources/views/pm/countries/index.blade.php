        ...
        <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="gap-3 d-grid">
                                        ...
                                        <label class="row form-check form-switch" for="toggleColumn_email">
                                            <span class="col-8 col-sm-9 ms-0">
                                                <span class="me-2">Type homologation</span>
                                            </span>
                                            <span class="col-4 col-sm-3 text-end">
                                        ...
                                        <label class="row form-check form-switch" for="toggleColumn_phone">
                                            <span class="col-8 col-sm-9 ms-0">
                                                <span class="me-2">Temps d'execution</span>
                                            </span>
                                            <span class="col-4 col-sm-3 text-end">
                                        ...
                                        <label class="row form-check form-switch" for="toggleColumn_country">
                                            <span class="col-8 col-sm-9 ms-0">
                                                <span class="me-2">Echantillon</span>
                                            </span>
                                            <span class="col-4 col-sm-3 text-end">
                                        ...
                                        <!-- Form Switch -->
                                        <label class="row form-check form-switch" for="toggleColumn_account_prix">
                                            <span class="col-8 col-sm-9 ms-0">
                                                <span class="me-2">Prix initial</span>
                                            </span>
                                            <span class="col-4 col-sm-3 text-end">
                                                <input type="checkbox" class="form-check-input"
                                                    id="toggleColumn_account_prix" checked>
                                            </span>
                                        </label>
                                        <!-- End Form Switch -->
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable"
                    ...
                    <tbody>
                        @foreach ($countries as $certificat)
                            @php
                                $random = rand(1, 4);
                            @endphp
                            <tr>
                                <td class="table-column-pe-0">
                                    <div class="form-check">
                                        <input type="checkbox" value="{{ $certificat->id }}"
                                            class="form-check-input users-data-check"
                                            id="usersDataCheck{{ $certificat->id }}">
                                        <label class="form-check-label" for="usersDataCheck{{ $certificat->id }}"></label>
                                    </div>
                                </td>
                                <td>
                                    <a class="d-flex align-items-center"
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <span class="h5 text-inherit">
                                                {{ $certificat->country->name_fr ?? $certificat->country->name_en }}
                                                {{-- <i class="bi-patch-check-fill text-primary" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="Top endorsed"></i></span> --}}
                                        </div>
                                    </a>
                                </td>
                                <td>{{ $certificat->typeHomologation->nom }}</td>
                                <td>{{ $certificat->leadTime->lead_time }}</td>
                                <td>{{ $certificat->typesEchantillon->nom ?? 'aucune' }}</td>
                                <td>{{ $certificat->validite }}</td>
                                <td>{{ $certificat->total_cost }}$</td>
                                <td>
                                    <div class="d-flex align-items-center gap-3 fs-6">
                                        <a href="{{ route('pm.countries.show', $certificat->country) }}"
                                        ...
                                        <a href="{{ route('pm.countries.edit', $certificat->id) }}" class="text-warning"
            ...
            <form class="modal-content" action="#" method="POST" id="delete-form">
                ...
                <div class="modal-body text-center">
                    <h5>
                        ...
                        Etez-vous sûr de vouloire supprimer ce pays ?
                    </h5>
                </div>
        ...
        <div class="modal-dialog">
            <form class="modal-content" action="#" method="POST" id="bulk-delete-form">
                ...
                <div class="modal-body text-center">
                    <h5>
                        <i class="bi bi-warning"></i>
                        Etez-vous sûr de vouloire supprimer ces pays ?
                    </h5>
                </div>
                <div class="modal-footer">
                    <a href="#" class="btn btn-success" data-bs-dismiss="modal">Annuler</a>
    ...
    <script>
        $(document).ready(function() {
            ...
            bulkdeleteToggle.on('click', function() {
                ...
                bulkDeleteForm.attr('action', '{{ route('pm.countries.bulkDestroy', '__ids') }}'.replace(
                    '__ids', ids));
            });
