...
@section('titre', 'ELIK6 - Nouveau partenaire')
...
@section('body')
    <div class="content container-fluid pb-5">
                    ...
                    <div class="">
                        <nav aria-label="breadcrumb">
                            <ol class="p-0 mb-0 breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ajouter un partenaires</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <form class="row g-3 justify-content-center" method="POST" action="{{ route('pm.partenaires.store') }}"
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" name="nom"
                                            placeholder="Non de la personne contact" required>
                                    </div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="row g-3">
                                    <div class="col-12">
                                        <fieldset class="p-3 border rounded mode_pay">
                                            ...
                                            {{-- <select class="form-select select2" name="mode_id" required
                                                data-placeholder="Choisir un mode de paiement" data-tags="false"
                                                data-get-items-route="{{ route('pm.partenaires.relation') }}" data-id=""
                                                data-related-model="ModesPaiement" data-label="mode" data-method="edit">
                                                $modePaiements
                                            </select> --}}
                                                ...
                                                <div class="pb-3 mx-0 mt-3 border rounded row g-3">
                                                    ...
                                                    <div class="col-12">
                                                        <label class="form-label">Adresse de la bank <sup
                                                                class="text-danger">*</sup></label>
                                                        <!--<input type="text" class="form-control" name="adresse_bank"-->
                                                        <!--    placeholder="Adresse de la banc" value="">-->
                                                        <textarea class="form-control" name="adresse_bank" placeholder="Adresse de la banc" rows="2" cols="4"></textarea>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="mode-agence d-none">
                                                <div class="pb-3 mx-0 mt-3 border rounded row g-3">
                                                    <div class="col-12 col-lg-6">
                                                        <label class="form-label">Nom du beneficiaire <sup
                                                                class="text-danger">*</sup></label>
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            placeholder="Téléphone du beneficiaire" value="">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                                ...
                                                <div class="pb-3 mx-0 mt-3 border rounded row g-3">
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <label class="form-label">Pays <sup
                                                                class="text-danger">*</sup></label>
                                                        <div class="mb-3 tom-select-custom">
                                                            <select class="js-select form-select" name="mod_country_id[]"
                                                                autocomplete="off"
                                                                data-hs-tom-select-options='{
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            placeholder="Prix de renouvellement" required>
                                                    </div>
                                                </div>
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-link" id="add-contact">Ajouter
                                            une modalité</a>
                                    </div>
                                </div>
                            </div>
