                ...
                <div class="card card-table">
                    ...
                    @if ($document)
                        <div class="attache-doc">
                            Le doument <span class="doc-item px-2"><i class="fi fi-rr-clip"></i> {{ $document->libelle }}</span> est attaché à cette tâche
                        </div>
                        <hr>
                    @endif
                        ...
                        <div class="form-group row g-lg-3 g-3">
                            <div class="col-lg-4">
                                <div class="row g-3">
                                            ...
                                            <div class="assignation-item">
                                                <select class="form-select select2" aria-label="Default select example"
                                                    ...
                                                    @foreach ($agents as $agent)
                                                        <option value="{{ $agent->id }}"> {{ $agent->prenom . ' ' }}
                                                            {{ $agent->nom }} </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <div class="mt-1 d-flex align-items-start">
                                                    <div class="flex-grow-1 objectif-container">
                                                        <div class="objectif-item">
                                                            <input type="text" name="objects[]" class="form-control"
                                                                placeholder="Objectif assigné" required>
                                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <label class="mb-2">Date de debut</label>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <select class="form-select select2" aria-label="Default select example"
                                            name="priorite_id">
                                            <option selected disabled value="">Selectionner une priorité</option>
                            ...
                            <div class="col-lg-8">
                                ...
                                <textarea name="description" id="textarea-edit" cols="30" rows="10" class="form-control"></textarea>
                            </div>
                            <div class="col-12">

                                <div id="dropzone-container" class="">
                                    <div id="dropzone">
                                        <p>Glissez et deposez vos fichiers ici<br>ou<br>Cliquez pour importer</p>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="mt-3 d-flex justify-content-end mt-lg-4">
                                    <button class="btn me-3" style="font-size: 14px">Annuler</button>
                                    <button class="btn btn-add" style="padding: 8px 24px">Créer</button>
                                </div>
                            </div>
                        </div>
                    </form>
