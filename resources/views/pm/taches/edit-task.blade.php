        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-table">
                    ...
                    <hr>
                    <form action="{{ route('arsp.taches.update', $tache->id) }}" method="POST"
                        ...
                        <div class="form-group row g-lg-3 g-3">
                            <div class="col-lg-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <label for="">Listes des documents</label>
