...
@section('body')
    <div class="content container-fluid">
        ...
        @livewire('taches.tache-detail', ['agents' => $agents])

        {{-- @foreach ($taches as $key => $tache)
            <div style="width: 600px;" class="offcanvas offcanvas-end offcanvas-task" tabindex="-1" id="detail-task-{{ $tache->id }}"
                        ...
                        <div class="form-group row g-3">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="tom-select-custom">
                                    <select class="js-select form-select form-select-sm" name="agents[]" id="agents"
                                        ...
                                        @foreach ($agents as $agent)
                                            <option value="{{ $agent->id }}"
                                                data-option-template='<span class="d-flex align-items-center"><img class="object-cover avatar avatar-xss avatar-circle me-2" src="{{ imageOrDefault($agent->image) }}" alt="{{ $agent->nom }}" /><span class="text-truncate">{{ $agent->prenom . ' ' . $agent->nom }}</span></span>'>
                                                {{ $agent->prenom . ' ' . $agent->nom }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-12">
                                ...
                                <small class="mb-2">(cette tâche sera une sous-tâche de celle que vous selectionnez
                                    ici)</small>
                                <div class="tom-select-custom">
                                    <select class="js-select form-select" name="parent_id" autocomplete="off"
                                        data-hs-tom-select-options='{
                                                "placeholder": "Selectionnez une tache parent"
                                            }'>
