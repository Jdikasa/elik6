...
class Document extends Component
{
    ...
    public function mount(Dossier $dossier)
    {
        ...
        $this->filterText = "Défaut";
    }

    public function render()
    {
        $this->documents = ModelsDocument::forCurrentTeam()->archive()->where('dossier_id', $this->dossier->id)->get(); //$this->dossier->documents->sortByDesc('created_at')
